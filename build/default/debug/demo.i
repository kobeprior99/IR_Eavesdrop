...
# 1 "./font.h" 1
# 12 "./font.h"
extern const unsigned char Terminal6x9[];
# 12 "demo.c" 2
...
void Demo1(void) {
    ...
    Oled_SetFont(Terminal6x9, 0);
# 41 "demo.c"
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("Ready", 0, 0, Display.X, 0x01);
    Delay_ms(1000);
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("Transmitting", 0, 0, Display.X, 0x01);
    Delay_ms(1000);
# 98 "demo.c"
}
