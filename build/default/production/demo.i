...
# 40 "demo.c"
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("Receiving", 32, 32, Display.X, 0x01);
# 93 "demo.c"
}
...
# 116 "demo.c"
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("", 32, 32, Display.X, 0x01);
# 169 "demo.c"
}
...
# 192 "demo.c"
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("Send", 32, 32, Display.X, 0x01);
# 245 "demo.c"
}
...
# 268 "demo.c"
    Oled_MemoryAccessControl(0x00);
    Oled_TextCenter("Ready", 32, 32, Display.X, 0x01);
# 321 "demo.c"
}
